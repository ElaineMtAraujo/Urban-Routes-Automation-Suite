# Recupera o código de telefone. Não altere
# Para revisores: o arquivo deve permanecer completamente inalterado

def retrieve_phone_code(driver) -> str:
    """Este código recupera o número de confirmação do telefone e o retorna como uma string.
    Use-o quando o aplicativo estiver aguardando o código de confirmação para utilizá-lo em seus testes.
...
# Verifica se o Routes está ativo e funcionando. Não altere
def is_url_reachable(url):
    """Verifique se a URL pode ser acessada. Passe a URL do Urban Routes como um parâmetro.
    Se puder ser acessada, retorna True (verdadeiro), caso contrário, retorna False (falso)"""
